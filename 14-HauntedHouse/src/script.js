...
bush2.position.set(1.4,0.2,2.5)

bush3.scale.set(0.4,0.4,0.4)
bush3.position.set(- 1.8,0.1,2.2)

bush4.scale.set(0.15,0.15,0.15)
bush4.position.set(- 2.1,0.05,2.6)
...
const tick = () =>
{
    ...
    ghost2.position.y = Math.sin(elapsedTime * 2.5) + Math.sin(elapsedTime * 3.5)

    const ghost3Angle = - elapsedTime * 0.66
    ghost3.position.x = Math.cos(ghost3Angle * 0.5) * (7 + Math.sin(elapsedTime * 0.32))
    ghost3.position.z = Math.sin(ghost3Angle * 0.5) * (7 + Math.sin(elapsedTime * 0.5))
    ghost3.position.y = Math.sin(elapsedTime * 3.5)
